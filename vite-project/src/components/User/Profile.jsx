...
export default function Profile() {
    ...
    const defaultAvatar =
        "https://images.unsplash.com/photo-1444703686981-a3abbc4d4fe3?fm=jpg&q=60&w=3000";
    ...
    const DB = async () => {
        if (!file) return showErrorToast("Please select a file first");
    ...
    return (
        <div
            ...
            style={{
                background:
                    "radial-gradient(circle at center, #0d0d0d, #000000 90%)",
                fontFamily: " cursive",
            }}
        >
            <div className="w-full max-w-2xl p-8 bg-black bg-opacity-90 rounded-xl shadow-2xl ring-2 ring-red-800 text-white">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="relative w-24 h-24 mb-4 border-4 border-red-700 rounded-full overflow-hidden glow-effect">
                        ...
                        <button
                            ...
                            className="absolute bottom-0 right-0 bg-red-700 border border-black p-1 rounded-full shadow-lg hover:bg-red-900 transition-all"
                        >
                            <svg
                    ...
                    <button
                        onClick={DB}
                        className="px-4 py-2 bg-red-800 hover:bg-red-900 rounded-full text-lg font-bold text-white transition-all"
                    >
                    ...
                    <h2 className="text-4xl font-bold text-red-600 mt-4 glow-text">
                        PROFILE
                    </h2>
                ...
                <div className="space-y-6 text-center sm:text-left sm:space-y-4 sm:px-4">
                    <div>
                        <label className="block text-lg font-semibold text-red-500 mb-1 glow-text">
                            Name:
                        </label>
                        {isEditing ? (
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    className="border border-red-700 px-3 py-1 rounded-md text-base w-full bg-black text-white"
                                />
                                <button
                                    onClick={handleNameUpdate}
                                    className="px-4 py-1 bg-red-800 hover:bg-red-900 rounded-md text-white font-bold"
                                >
                                    Save
                                </button>
                                <button
                                    onClick={() => setIsEditing(false)}
                                    className="px-3 py-1 bg-gray-800 hover:bg-gray-700 rounded-md text-gray-300"
                                >
                                    Cancel
                                </button>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    className="text-sm text-red-500 hover:underline glow-text"
                                >
                                    Edit
                                </button>
                            </div>
