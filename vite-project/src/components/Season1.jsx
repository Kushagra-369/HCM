...
export default function Season1() {
  return (
    <div className='  bg-black text-white'>
        ...
        <div className=' px-5 '>
            <h1>`
                <h1 className='text-center font-bold'>EMPTY SPACES PART-1</h1> <br /> <br />
...
Interval 1 <br/><br/>
 ...
 <h1 className='text-center font-bold'>EMPTY SPACES PART-2</h1>
 <br />
...
INTERVAL -2 <br/><br/>
 ...
 <h1 className='text-center font-bold'>EMPTY SPACES PART-3</h1>
 <br />
...
<h1 className='text-center font-bold'>EMPTY SPACES PART-4</h1>
 <br />
 </h1>
...
<h1 className='text-center font-bold'>EMPTY SPACES SEASON FINALE</h1>
 <br />
...
Here’s the text formatted with `<br/>` tags as requested, with one `<br/>` tag after every paragraph and two `<br/><br/>` tags after the completion of each person's dialog block.
