...
export default function Empty_Spaces() {
  return (
    <Element name='about_empty_spaces'>
      <motion.div
        className="h-full bg-gradient-to-b from-black via-gray-800 to-black flex items-center justify-center px-6 py-20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
        <motion.div
          className="bg-white/5 border w-100 xl:w-300 2xl:w-500 animated-gradient-borders border-white/10 backdrop-blur-md rounded-xl p-10  w-full text-white text-center shadow-lg"
